      ...
      >
        <header>
          <div>
            ...
            <h2 id="new-title">¿Qué quieres crear?</h2>
          </div>
          <button
            ref={closeButton}
        ...
        <button onClick={() => onChoose("/contactos/nuevo?tipo=customer")}>
          ...
          <span>
            ...
            <small>Datos fiscales y de contacto</small>
          </span>
        </button>
        <button onClick={() => onChoose("/contactos/nuevo?tipo=supplier")}>
          <Store />
          <span>
            <strong>Nuevo proveedor</strong>
            <small>También puede ser cliente</small>
          </span>
        </button>
        <button onClick={() => onChoose("/productos/nuevo")}>
          <PackagePlus />
          <span>
