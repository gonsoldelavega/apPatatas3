...
export function ContactFormPage() {
  ...
  useEffect(() => {
    ...
    reset({
      ...
      legalName: contact.data.legalName,
      tradeName: contact.data.tradeName ?? "",
      taxId: contact.data.taxId ?? "",
      email: contact.data.email ?? "",
      phone: contact.data.phone ?? "",
      street: contact.data.address.street ?? "",
      line2: contact.data.address.line2 ?? "",
      postalCode: contact.data.address.postalCode ?? "",
      city: contact.data.address.city ?? "",
      province: contact.data.address.province ?? "",
      country: contact.data.address.country ?? "ES",
      notes: contact.data.notes ?? "",
      paymentTermsDays: contact.data.paymentTermsDays,
  ...
  if (id && contact.isLoading)
    return <LoadingScreen label="Cargando contacto" />;
  if (id && contact.isError)
    return (
      <div className="page">
        <EmptyState
