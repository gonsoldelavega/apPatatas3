-- Allow a verified Google identity to create its own isolated company account.
-- The API can only call this narrow function; it receives no direct cross-tenant
-- privileges. Existing users are linked to their existing membership.
